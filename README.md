...
This project analyzes bank card transaction performance and risk indicators using Power BI. The dashboard is designed to help business stakeholders monitor card spend, transaction success, card product performance, customer value, merchant behavior, and credit risk exposure in one centralized analytical report.

The dashboard flow is designed to move from a high-level business summary to deeper operational and risk analysis:

1. **Performance Overview**: Understand overall portfolio performance and transaction health.
2. **Card Performance**: Evaluate card products, card types, card brands, credit limit groups, and dormant card opportunities.
3. **Customer Value**: Analyze customer segments, active client behavior, spend intensity, and value drivers.
4. **Merchant Spend**: Identify merchant categories that drive spend, transaction volume, and average transaction value.
5. **Credit Risk**: Monitor high-risk clients, credit score distribution, DTI ratio, debt burden, and risk exposure.

## Business Objectives

The main objective is to transform bank card data into actionable insights for performance monitoring, product optimization, customer growth, merchant strategy, and credit risk management.
...
- Which card types, card brands, and card products contribute the most to spend?
- Where are dormant card opportunities concentrated?
- Which customer segments generate the highest value?
- Which merchant categories drive the largest spend and transaction volume?
...
- Business users need to compare spend, transaction success, card activity, customer value, merchant behavior, and risk in one place.
...
1. **Overview**: Start with executive KPIs and transaction health.
2. **Card Performance**: Move into product performance, active cards, card type, card brand, and dormant opportunity.
3. **Customer Value**: Analyze who is generating value and where customer activation opportunities exist.
...
<img width="2900" height="1646" alt="image" src="https://github.com/user-attachments/assets/7fe7a6b1-907a-4d5c-b668-40b6d7c6cb22" />
